...
Yrda is a strange and wondrous place. There are lush jungles full of
dangerous beasts and dinosaurs. There are expansive deserts with ancient
ruins and powerful artifacts hidden beneath the dunes. There are long
mountain ranges punctuated by violent, active volcanos. All of these
places are inhabited to one degree or another. Civilizations of varying
degrees of technological progress and wildly different cultures exist
all over Yrda.

Chief among these are the authoritarian Kingdom of Makhet, the spiritual
Inyani, the imperialistic Kingdom of Gaddar, and the mysterious
Illdrazi. Not all are political, but all are important in their own
right.
...
Authoritarian kingdom with a heavily oppressed populace. The rule of law
is considered more important than anything else.

NOTE: Makhet is based on Babylon.

=== The Kingdom of Gaddar

NOTE: Gaddar is based on the Minoans.

=== The Empire of Sushani
...
One of those is the Den of Purity, a valley that only Soul Hunters can
find.
...
- Yrdish - the common language of Yrda

- Old Yrdish - a more archaic version of Yrdish, this is no longer
  spoken outside of scholarly circles or some lost cultures

- Gaddari - the language of the Gaddar people

- Makhetian - the language of the Makhet culture, spoken primarily in
  the Kingdom of Makhet

- Ardonan - the language of the Ardonan culture, spoken primarily in the
  Ardonan Reaches and western parts of the Sushani Empire

- Sushani - the language of the Sushani culture, spoken primarily in the
  Sushani Empire

There are many lands and cultures in Yrda. The Game Master and the
players can work together to make up new languages.
